...
namespace Game {
	...
	static const float kHunger = 0.00005;
	
	static const float kMinionPrivacyRadius = 8.0;
	static const float kMinionWalkSpeed = 0.01;
	
	static const float kFoodExchangeStartup = 0.4;
	static const float kInflation = 0.000003;
}
